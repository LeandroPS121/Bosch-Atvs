...
public class WeatherHistoryService {
    ...
    private final Gson gson = new GsonBuilder()
            .registerTypeAdapter(LocalDateTime.class, new TimeFormatter())
            .create();

    // Garante a existencia do dir
    ...
    // Salva uma nova consulta em um arquivo JSON
    ...
    private void saveIndividualHistory(WeatherQuery query) {
        ...
        try (FileWriter writer = new FileWriter(individualFile)) {
            ...
            System.out.println("Arquivo salvo: " + individualFile.getAbsolutePath());
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
